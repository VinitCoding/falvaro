...
const FoodCard = ({id, image, name, price, desc, category, rating}) => {
    return (
        ...
        <div className='mb-3'>
            <div className='lg:w-[300px] md:w-[250px] sm:w-[250px] w-auto h-[290px] bg-white border-[0.5px] shadow p-3 items-center rounded mx-3 hover:shadow-lg cursor-pointer'>
                ...
                <div className='flex items-center justify-between mt-3'>
                    <p className='flex items-center'><IoIosStar className='text-yellow-400'/> {rating}</p>
                    <button className='px-2 py-1 text-white bg-green-500 rounded hover:shadow-md hover:shadow-green-400'>Add to cart</button>
                </div>
            </div>
