  ...
  return (
    ...
    <div className='fixed top-0 right-0 lg:w-[20vw] md:w-[40vw] w-full h-full bg-white p-4 '>
      ...
      <div className='absolute bottom-0 '>
        ...
        <button className='lg:w-[18vw] md:w-[37vw] sm:w-[95vw] w-[90vw] mb-4 px-2 py-1 text-white bg-green-500 rounded hover:shadow-md hover:shadow-green-400'>Checkout</button>
      </div>
    </div> 
  )
}
